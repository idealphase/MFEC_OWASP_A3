...
$create_tb = "CREATE TABLE users (user_id int(6),first_name varchar(15),last_name varchar(15), user varchar(15), password varchar(32),avatar varchar(70), last_login TIMESTAMP, failed_login INT(3), salary varchar(50), PRIMARY KEY (user_id));";
...
$insert = "INSERT INTO users VALUES
	('1','Pituphong','Yavirach','admin',MD5('password'),'{$avatarUrl}admin.jpg', NOW(), '0', 'TUZFQ3tTZW5zaXQxd'),
	('2','Sornram','Kampeera','gordonb',MD5('abc123'),'{$avatarUrl}gordonb.jpg', NOW(), '0', 'mVfZDR0NF9lWHAwc3'),
	('3','Jettapol','Pumwattanakul','1337',MD5('charley'),'{$avatarUrl}1337.jpg', NOW(), '0', 'VyRV9leF95MHVyX3M'),
	('4','Jirawat','Vuthawiphat','pablo',MD5('letmein'),'{$avatarUrl}pablo.jpg', NOW(), '0', '0TDRyWV9hTmRfd2gz'),
	('5','Kitchaphan','Singchai','smithy',MD5('password'),'{$avatarUrl}smithy.jpg', NOW(), '0', 'cjNfdDBfZjFuZF9UaDNtfQ==');";
